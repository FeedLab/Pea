...
public class PeaAdapterLive : IPeaAdapter
{
 private readonly ILogger<PeaAdapterLive> logger;
    ...
    private async Task<IList<PeaMeterReading>?> ShowDailyReadingsInternal(DateTime selectedDate)
    {
